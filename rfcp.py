...
def main():
    ...
    while True:
        ...
        print(Fore.YELLOW + "[2.] TOKEN GETTER" + Style.RESET_ALL)
        print(Fore.YELLOW + "[3.] POST ID GETTER" + Style.RESET_ALL)
        print(Fore.YELLOW + "[4.] REMOVE INVALID ACCOUNT" + Style.RESET_ALL)
        print(Fore.YELLOW + "[0.] STOP" + Style.RESET_ALL)  # Option to stop
        ...
        if choice == '1':
            ...
            run_script('tools/tkg.py')
        elif choice == '3':
            run_script('tools/postid.py')
        elif choice == '4':
